...
const NAV_ICONS = {
  ...
  "/admin/jobs":            /* briefcase*/(p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 0 0-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0 1 12 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 0 1-.673-.38m0 0A2.18 2.18 0 0 1 3 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 0 1 3.413-.387m7.5 0V5.25A2.25 2.25 0 0 0 13.5 3h-3a2.25 2.25 0 0 0-2.25 2.25v.894m7.5 0a48.667 48.667 0 0 0-7.5 0" /></svg>,
  "/admin/schedule-requests": /* handoff */(p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" /></svg>,
  "/admin/crew":            /* people */ (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" /></svg>,
  "/admin/cranes":          /* crane */  (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M4 21V3m0 0h12l-2 4 2 4H4m0 0v2m0-2l9 7m0 0v4m0-4l-2 1" /></svg>,
  ...
  "/admin/daily-board":     /* monitor */ (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25m18 0A2.25 2.25 0 0 0 18.75 3H5.25A2.25 2.25 0 0 0 3 5.25m18 0V12a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 12V5.25" /></svg>,
  "/admin/field-reports":   /* clipboard*/(p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" /></svg>,
  "/admin/certifications":  /* shield */  (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" /></svg>,
  ...
  "/admin/blog":            /* document */ (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H6.375A2.625 2.625 0 0 0 3.75 4.875v14.25a2.625 2.625 0 0 0 2.625 2.625h11.25a2.625 2.625 0 0 0 2.625-2.625V14.25Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 3.75v4.5a1.5 1.5 0 0 0 1.5 1.5h4.5m-12 4.5h9m-9 3h6" /></svg>,
  ...
  "/admin/job-costs":        /* chart */   (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" /></svg>,
  "/admin/change-orders":    /* pencil */  (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487 18.549 2.799a2.122 2.122 0 1 1 3 3L19.862 7.487m-3-3L6.34 15.01a4.5 4.5 0 0 0-1.13 1.897l-.869 2.872a.75.75 0 0 0 .933.933l2.872-.869a4.5 4.5 0 0 0 1.897-1.13l10.52-10.52m-3-3 3 3" /></svg>,
  "/admin/revenue-reports":  /* doc+chart*/(p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H6.375A2.625 2.625 0 0 0 3.75 4.875v14.25a2.625 2.625 0 0 0 2.625 2.625h11.25a2.625 2.625 0 0 0 2.625-2.625V14.25Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 3.75v4.5a1.5 1.5 0 0 0 1.5 1.5h4.5M8.25 17.25v-3M11.25 17.25v-5.25M14.25 17.25v-1.5" /></svg>,
  "/admin/client-portal":   /* link */    (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" /></svg>,
...
const FEEDBACK_TYPES = [
  { id: "positive", label: "Positive", icon: "👍", color: "border-emerald-300 bg-emerald-50 text-emerald-800" },
  { id: "suggestion", label: "Suggestion", icon: "💡", color: "border-amber-300 bg-amber-50 text-amber-800" },
  { id: "negative", label: "Issue", icon: "⚠️", color: "border-rose-300 bg-rose-50 text-rose-800" },
];

function FeedbackModal({ open, onClose, currentPage, user, profile, role }) {
    ...
    try {
      const res = await fetch("/api/admin-feedback", {
        ...
        body: JSON.stringify({
          ...
          user_name: profile?.full_name || profile?.username || user?.email || null,
  ...
  }, [feedbackText, feedbackType, submitting, currentPage, user, profile, role, onClose]);
      ...
      >
        {submitted ? (
          <div className="px-6 py-10 text-center">
            ...
            <p className={`${lato.className} text-lg font-bold text-neutral-900`}>Thank you!</p>
            <p className="mt-1 text-sm text-neutral-500">Your feedback has been submitted.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            <div className="flex items-center justify-between border-b border-neutral-100 px-5 py-4">
              <div>
                <h2 className={`${lato.className} text-base font-bold text-neutral-900`}>Send Feedback</h2>
                <p className="text-[11px] text-neutral-500">
                  From: <span className="font-mono">{currentPage}</span>
                </p>
              </div>
              <button type="button" onClick={onClose} className="rounded-lg p-1.5 text-neutral-400 hover:bg-neutral-100 hover:text-neutral-600 transition-colors">
            ...
            <div className="px-5 py-4 space-y-4">
              {/* Type selector */}
              <div>
                <p className="mb-2 text-xs font-semibold text-neutral-500">What kind of feedback?</p>
                <div className="grid grid-cols-3 gap-2">
                  {FEEDBACK_TYPES.map((ft) => (
                    ...
                    >
                      <span className="block text-lg">{ft.icon}</span>
                      <span className="block text-[11px] font-semibold mt-0.5">{ft.label}</span>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  required
                  className="w-full resize-none rounded-xl border border-neutral-300 px-3 py-2.5 text-sm leading-relaxed transition-colors focus:border-brand focus:ring-2 focus:ring-brand/20 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-2 border-t border-neutral-100 px-5 py-3">
              ...
              <button
                ...
                className="rounded-lg bg-[#0b2a5a] px-4 py-2 text-sm font-semibold text-white shadow-sm transition-all hover:bg-[#143a75] hover:shadow-md disabled:opacity-60"
              >
...
export default function TWAdminLayout({ children }) {
  ...
  const { user, profile, role, accessLevel, logout } = useAuth();
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-neutral-100">
        ...
        <header className="flex items-center gap-3 border-b border-neutral-200 bg-white px-4 py-3 lg:px-6">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg bg-[#0b2a5a] px-3 py-1.5 text-[11px] font-semibold text-white shadow-sm transition-all hover:bg-[#143a75] hover:shadow-md"
            >
      ...
      {/* Feedback modal — available on all admin pages */}
      <FeedbackModal
        open={feedbackOpen}
