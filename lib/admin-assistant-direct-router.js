...
function buildPromptForSurface(surface) {
  switch (surface?.type) {
    ...
    case "schedule_builder_context":
      return `Let's build the schedule for ${surface.targetDateFormatted}. Your crew and active jobs are shown below. Tell me who goes on which rig, or tap a quick action to get started.`;
