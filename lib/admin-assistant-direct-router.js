  ...
  switch (surface?.type) {
    ...
    case "sales_pipeline_list": {
      const preview = surface.demoMode
        ...
        : "";
      return `${preview}I opened the sales pipeline surface below so you can scan pre-award opportunities (or try the preview) without leaving the thread.`;
    }
    case "sales_opportunity_create":
      return "I opened a form below to add a pre-award opportunity to the same pipeline as the Sales page.";
    default:
