...
export const ROLE_OPTIONS = [
  ...
  },
  {
    value: "admin",
    label: "Admin (IT)",
    description: "Full access to every admin page and tool.",
  },
  {
    value: "operations",
    label: "Operations",
  ...
  },
  {
    value: "hr",
    label: "HR",
    description: "Crew job entry and editing in the scheduler.",
  },
  {
    value: "sales",
    label: "Sales",
    description: "Lead and submission visibility without write actions.",
  },
  {
    value: "viewer",
    label: "Staff / Viewer",
    description: "Assistant chat only with no admin writes.",
  },
];
...
const OPERATIONS_PERMISSIONS = {
  ...
  chatTools: [...SCHEDULE_TOOLS, ...CAREER_TOOLS, ...CONTACT_TOOLS, ...SPAM_TOOLS, ...IMAGE_TOOLS, ...RAG_TOOLS],
  canWrite: true,
...
export const ROLE_PERMISSIONS = {
  admin: {
    ...
    chatTools: [...SCHEDULE_TOOLS, ...SOCIAL_TOOLS, ...CAREER_TOOLS, ...CONTACT_TOOLS, ...SPAM_TOOLS, ...IMAGE_TOOLS, ...RAG_TOOLS, ...ADMIN_TOOLS],
    canWrite: true,
