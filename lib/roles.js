...
export const ROLE_PERMISSIONS = {
  ...
  social_media: {
    pages: ["/admin", "/admin/dashboard", "/admin/social-media", "/admin/blog", "/admin/image-assignments"],
    chatTools: [...SOCIAL_TOOLS, ...IMAGE_TOOLS, ...RAG_TOOLS],
    canWrite: true,
    dataModules: ["social"],
  },
  hr: {
    pages: ["/admin", "/admin/crew-scheduler", "/admin/daily-board", "/admin/field-reports", "/admin/certifications", "/admin/hiring"],
    chatTools: [...JOB_ENTRY_TOOLS, ...HIRING_TOOLS, ...RAG_TOOLS],
    canWrite: true,
    dataModules: ["schedule", "hiring"],
  },
  sales: {
    pages: ["/admin", "/admin/contact", "/admin/sales", "/admin/change-orders"],
