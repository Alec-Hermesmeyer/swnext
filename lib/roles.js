...
const OPERATIONS_PERMISSIONS = {
  // Ops lives through the whole job lifecycle: win → run → money.
  // Certifications included so they can verify crew creds before assigning.
  pages: [
    // Start
    "/admin",
    "/admin/dashboard",
    ...
    "/admin/job-costs",
    "/admin/change-orders",
    // People (cert visibility for scheduling decisions)
