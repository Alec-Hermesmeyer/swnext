...
const OPERATIONS_PERMISSIONS = {
  ...
  chatTools: [...SCHEDULE_TOOLS, ...CAREER_TOOLS, ...CONTACT_TOOLS, ...SPAM_TOOLS, ...IMAGE_TOOLS, ...SALES_TOOLS, ...HIRING_TOOLS, ...RAG_TOOLS],
  canWrite: true,
...
export const ROLE_PERMISSIONS = {
  admin: {
    ...
    chatTools: [...SCHEDULE_TOOLS, ...SOCIAL_TOOLS, ...CAREER_TOOLS, ...CONTACT_TOOLS, ...SPAM_TOOLS, ...IMAGE_TOOLS, ...SALES_TOOLS, ...HIRING_TOOLS, ...RAG_TOOLS, ...ADMIN_TOOLS],
    canWrite: true,
