...
const OPERATIONS_PERMISSIONS = {
  ...
  chatTools: [...SCHEDULE_TOOLS, ...CAREER_TOOLS, ...CONTACT_TOOLS, ...IMAGE_TOOLS],
  canWrite: true,
...
export const ROLE_PERMISSIONS = {
  admin: {
    ...
    chatTools: [...SCHEDULE_TOOLS, ...SOCIAL_TOOLS, ...CAREER_TOOLS, ...CONTACT_TOOLS, ...IMAGE_TOOLS, ...ADMIN_TOOLS],
    canWrite: true,
  ...
  social_media: {
    ...
    chatTools: [...SOCIAL_TOOLS, ...IMAGE_TOOLS],
    canWrite: true,
    dataModules: ["social"],
  },
  hr: {
