...
export function buildAssistantSurface({
  ...
  // Image-related queries — don't attach a surface, let the chatbot tools handle it
  // but DO prevent the schedule overview from catching "page images" or "gallery"
  if (
    includesAny(text, [
      "page image",
      "page images",
    ...
    return null; // Let Groq + tools handle it
  }
