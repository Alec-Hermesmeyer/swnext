  ...
  switch (name) {
    ...
    case "search_knowledge_base": {
      ...
      try {
        ...
        // Prefix short queries so the embedding captures domain intent better.
        // For bidding-focused queries include "bid proposal" to steer the
        // embedding vector closer to the proposal chunk cluster.
        let embeddingInput = query;
        if (query.length < 60) {
          const domainPrefix = biddingFocus
            ? "S&W Foundation Contractors bid proposal: "
            : "S&W Foundation Contractors: ";
          embeddingInput = domainPrefix + query;
        }
