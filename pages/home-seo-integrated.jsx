...
function InfoBlocks() {
  ...
  return (
    <section 
      className="relative w-screen -ml-[50vw] -mr-[50vw] left-1/2 right-1/2 bg-white"
      role="main"
...
function Services() {
  ...
  return (
    <section 
      className="relative w-screen -ml-[50vw] -mr-[50vw] left-1/2 right-1/2 py-16 md:py-24 bg-gradient-to-r from-red-700 via-white to-[#0b2a5a]"
      role="region"
...
export default function HomeIntegratedSEO() {
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
      ...
      <main className="flex w-full flex-col" id="main-content" role="main">
        <Hero />
        <InfoBlocks />
        <Services />
        <ContactCTA />
...
// This tells Next.js to use TWLayout.jsx for this page
HomeIntegratedSEO.getLayout = function getLayout(page) {
  const TWLayout = require('@/components/TWLayout.jsx').default;
