...
// }
// /**
//  * Fetches and displays contact information from a Supabase database.
//  * Uses hooks for state management and effects to handle asynchronous data fetching.
//  */
...
//               {contact.job_title}<br></br>
//               <br></br>
//               <Link className={styles.email} href={`mailto:${contact.email}`}>{contact.email}</Link> <br></br>
//               <br></br>
//               <Link className={styles.contactNumber} href={`tel:${contact.phone}`}>{contact.phone}</Link>
//             </p>
//           </div>
//         ))}
//       </div>
