        ...
        <div className="p-6 lg:max-h-[calc(100vh-16rem)] lg:overflow-y-auto">
          {!selectedDoc ? (
            ...
            <div className="space-y-4">
              ...
              <CollapsibleSection
                title="Insights & Risk"
                subtitle="Risk flags, scope, assumptions, exclusions"
                ...
                icon={<svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" /></svg>}
              >
                <div className="space-y-4">
                  {/* Risk Flags */}
              ...
              <CollapsibleSection
                title="Ask This Bid"
                subtitle="RAG-powered Q&A against this document"
                badge={chatHistory.length ? `${chatHistory.length} messages` : null}
                badgeTone="sky"
