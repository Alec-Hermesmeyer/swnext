            ...
            <div className={`grid grid-cols-1 items-center gap-6 p-6 md:p-12 md:grid-cols-2 ${imageRight ? '' : 'md:[&>div:first-child]:order-2'}`}>
              ...
              <div className={`flex items-center ${imageRight ? 'justify-end' : 'justify-start'}`}>
                <div className={`relative aspect-[4/3] w-full max-w-xl overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black/10 ${imageRight ? 'md:-mr-8' : 'md:-ml-8'}`}>
                  <Image src={img} alt={title} fill sizes="(min-width: 768px) 600px, 90vw" className="object-cover" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="relative mx-auto w-full max-w-[1600px] px-6 md:px-10">
        <FadeInStagger>
          <InfoBlock
            ...
            img="Images/public/IMG_7617.webp"
            bar="red"
            imageRight
          />
          <InfoBlock
            ...
            img="Images/public/2rigs1pipe.webp"
            bar="#0b2a5a"
            imageRight={false}
          />
          <InfoBlock
            ...
            img="Images/public/1703009714442.webp"
            bar="red"
            imageRight
          />
          <InfoBlock
            ...
            img="Images/public/IMG_7621.webp"
            bar="#0b2a5a"
            imageRight={false}
          />
        </FadeInStagger>
  ...
  return (
    <section className="relative w-screen -ml-[50vw] -mr-[50vw] left-1/2 right-1/2 text-white min-h-[50vh] md:min-h-[55vh] flex items-center">
      <div className="absolute inset-0">
        <Image src="https://edycymyofrowahspzzpg.supabase.co/storage/v1/object/public/Images/public/IMG_7753.webp" alt="cta" fill className="object-cover object-bottom" />
      </div>
