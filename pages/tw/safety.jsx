...
function Hero() {
  return (
    <section className="relative w-screen -ml-[50vw] -mr-[50vw] left-1/2 right-1/2 text-white min-h-[40vh] md:min-h-[50vh] flex items-center">
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('https://edycymyofrowahspzzpg.supabase.co/storage/v1/object/public/Images/public/newimages/IMG_7642.webp')", backgroundPosition: "center" }} />
        ...
        <section className="mx-auto w-full max-w-[1200px] px-6 py-10">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="rounded-2xl bg-[#0b2a5a] p-6 text-white shadow ring-1 ring-white/10">
              <h2 className={`${lato.className} text-2xl font-extrabold`}>Safety is non-negotiable</h2>
              <p className="mt-3 leading-relaxed text-white/90">We uphold the highest standards of safety and execution across all jobsites, with proactive training and accountability.</p>
            ...
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/10">
              <Image src="/galleryImages/gal12.jpeg" alt="Safety" fill sizes="(min-width: 768px) 600px, 90vw" className="object-cover" unoptimized loader={({src})=>src} />
            </div>
          </div>
        </section>
      </main>
