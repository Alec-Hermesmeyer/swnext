        ...
        <section className="mx-auto w-full max-w-[1200px] px-6 py-10">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="rounded-2xl bg-[#0b2a5a] p-6 text-white shadow ring-1 ring-white/10">
              <h2 className={`${lato.className} text-2xl font-extrabold`}>Engineered for longevity</h2>
              <p className="mt-3 leading-relaxed text-white/90">Efficient, reliable helical pile systems designed for permanent support in variable soils.</p>
            ...
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/10">
              <Image src="/galleryImages/gal31.jpeg" alt="Helical Piles" fill sizes="(min-width: 768px) 600px, 90vw" className="object-cover" unoptimized loader={({src})=>src} />
            </div>
          </div>
        </section>
      </main>
